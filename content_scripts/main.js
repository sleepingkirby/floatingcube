      ...
      <div class="${id}RghtPnl" style="display:flex; border-top:1px solid ${wht};border-left:1px solid ${wht};flex-direction:column; align-items:stretch; justify-content:flex-end; font-size:smaller; min-width:80px;">
        ...
        <div id="${id}RghtPnlPrflRow" style="display:flex; flex-direction:row; justify-content:flex-end; align-items:stretch; max-width:400px; max-height:80px; overflow:hidden; transition: all 0.3s linear; align-self:flex-end;">
          <div style="display:flex; flex-direction:row; justify-content:flex-end; align-items:center;">
            <button title="Save Profile" style="margin:0px; display:flex; background-color:${wht}; color:${blck}; padding:1px 4px; border-radius:6px; border:1px solid #666666; font-family:initial; text-shadow:none;box-sizing:border-box; border-bottom:0px; border-right:0px; border-radius:3px 3px 0px 3px;width:fit-content;text-wrap:nowrap;min-width:36px;justify-content:center;align-items:center;font-weight:1000;" clickAction="savePrfl">🖫</button>
